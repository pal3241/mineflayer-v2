...
- Open/close wooden serta supported copper door dan trapdoor dengan state verification dan cooldown. Iron door ditolak karena membutuhkan mekanisme redstone.
...
Test survival mencakup armor upgrade dan downgrade protection, low-durability rejection, sheep/wool, cow/milk, sleep/wake, door/trapdoor, iron-door rejection, serta special-source Acquisition. Seluruh operation mengembalikan hasil terverifikasi atau structured error yang eksplisit.

## Scope

Phase ini menyiapkan capability survival reusable. Helping Core, koordinasi sleep multi-bot penuh, feeding, breeding, taming, trading, mounting, dan navigasi door-aware otomatis lanjutan berada pada phase berikutnya.
