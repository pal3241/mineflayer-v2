...
public final class MineHiveClient implements ClientModInitializer {
    ...
    private void renderHud(net.minecraft.client.gui.DrawContext draw) {
        ...
        draw.fill(6, 6, 520, controlledBotId == null ? 31 : 43, 0xB0101815); draw.drawTextWithShadow(client.textRenderer, Text.literal("MineHive 1.3.0 · " + api.status()), 12, 11, color);
