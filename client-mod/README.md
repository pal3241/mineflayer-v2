...
Install `client-mod/build/libs/minehive-client-1.2.1.jar` with Fabric Loader and Fabric API for Minecraft 1.21.1. Litematica is an optional compatibility provider, not a required dependency.
