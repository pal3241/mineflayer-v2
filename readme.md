...
- Dashboard untuk join, monitoring, live camera, command, admin, settings, dan logistik
- Command individual, kelompok, dan global melalui alias bot atau class
- Movement, follow, home, collect, crafting, farming, forestry, dan combat
