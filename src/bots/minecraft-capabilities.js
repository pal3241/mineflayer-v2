...
export const MINECRAFT_CAPABILITIES = Object.freeze([
  ...
  'minecraft.build-site-scan',
  'minecraft.navigation', 'minecraft.navigation-stop', 'minecraft.navigation-target', 'minecraft.navigation-pillar', 'minecraft.navigation-bridge', 'minecraft.smart-movement', 'minecraft.follow-player', 'minecraft.come', 'minecraft.set-home', 'minecraft.home', 'minecraft.crafting', 'minecraft.craft-planning', 'minecraft.smelting', 'minecraft.block-analysis', 'minecraft.resource-analysis', 'minecraft.survey', 'minecraft.storage-discovery', 'minecraft.storage-inspection', 'minecraft.storage-deposit', 'minecraft.storage-withdraw', 'minecraft.collection', 'minecraft.farming', 'minecraft.food-forage', 'minecraft.deforestation', 'minecraft.reforestation', 'minecraft.combat', 'minecraft.drop-item', 'minecraft.pickup-item', 'minecraft.equip', 'minecraft.unequip', 'minecraft.use-item', 'minecraft.interact-entity', 'minecraft.interact-block', 'minecraft.entity-search', 'minecraft.armor.inspect', 'minecraft.armor.equip', 'minecraft.armor.auto-equip', 'minecraft.sheep-search', 'minecraft.shear', 'minecraft.shear-nearest', 'minecraft.acquire-wool', 'minecraft.cow-search', 'minecraft.milk', 'minecraft.milk-nearest', 'minecraft.acquire-milk', 'minecraft.bed-search', 'minecraft.sleep', 'minecraft.wake', 'minecraft.sleep-status', 'minecraft.open-door', 'minecraft.close-door', 'minecraft.open-trapdoor', 'minecraft.close-trapdoor', 'minecraft.chat', 'minecraft.observation', 'minecraft.inventory', 'minecraft.stop'
]);
...
export function registerMinecraftCapabilities(registry, botManager, survival) {
  ...
  registry.register({ name: 'minecraft.build-site-scan', execute: (input, context) => invokeRequired(adapter(context), 'inspectBuildSite', input) });
  ...
  registry.register({ name: 'minecraft.shear-nearest', execute: (input, context) => survival.shearNearest(runtime(context), input, context) });
  ...
  registry.register({ name: 'minecraft.milk-nearest', execute: (input, context) => survival.milkNearest(runtime(context), input, context) });
  ...
  registry.register({ name: 'minecraft.food-forage', execute: (input, context) => adapter(context).forageFood(input, context) });
