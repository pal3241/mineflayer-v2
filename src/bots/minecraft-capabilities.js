export const MINECRAFT_CAPABILITIES = Object.freeze([
  'minecraft.navigation', 'minecraft.smart-movement', 'minecraft.follow-player', 'minecraft.set-home', 'minecraft.home', 'minecraft.crafting', 'minecraft.collection', 'minecraft.drop-item', 'minecraft.pickup-item', 'minecraft.chat', 'minecraft.observation', 'minecraft.inventory', 'minecraft.stop'
]);
