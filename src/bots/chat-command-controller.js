const HELP = 'commands: status, come, follow [player], goto <x> <y> <z>, collect, farm, deforest, reforest, guard, combat, meat, remember, place, craft, natural language, inventory, stop';
...
export class ChatCommandController {
  ...
  async #handle(runtime, username, message) {
    ...
    try {
      ...
      if (['ai', 'collect', 'craft', 'farm', 'farming', 'deforest', 'reforest', 'guard', 'combat', 'meat', 'remember', 'place'].includes(command)) {
