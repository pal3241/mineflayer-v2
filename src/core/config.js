...
export function loadConfig(env = process.env) {
  const config = {
    ...
    llm: { provider: env.MINEHIVE_LLM_PROVIDER ?? 'auto', endpoint: env.MINEHIVE_LLM_ENDPOINT, apiKey: env.OPENROUTER_API_KEY, model: env.MINEHIVE_LLM_MODEL ?? 'openrouter/auto', siteUrl: env.MINEHIVE_SITE_URL,
