...
export class Application {
  constructor(config, overrides = {}) {
    ...
    this.bots.onCreated(runtime => { this.chatCommands.attach(runtime); this.structureObserver.attach(runtime); this.survival.attach(runtime); void this.combat.bind(runtime).catch(error => this.logger.warn('combat.bind.failed', { botId: runtime.bot.id, error: error.message })); });
