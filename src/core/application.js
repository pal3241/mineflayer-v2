...
export class Application {
  constructor(config, overrides = {}) {
    ...
    this.chatCommands = new ChatCommandController({ goalService: this.goals, executor: this.executor, capabilities: this.capabilities, coordinator: this.coordinator, helpCommands: this.helpCommands, navigation: this.navigation, botProfiles: this.botProfiles, config: config.commands ?? { enabled: false, admins: [] }, logger: this.logger });
