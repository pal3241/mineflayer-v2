...
export class Application {
  constructor(config, overrides = {}) {
    ...
    this.building = createBuildingService({ repository: repository('building-projects'), settingsRepository: repository('building-settings'), events: this.events, bots: this.bots, capabilities: this.capabilities, memory: this.universalMemory, acquisition: this.acquisition, fleetTransfer: this.fleetTransfer, workshops: this.workshops, settings: config.building });
