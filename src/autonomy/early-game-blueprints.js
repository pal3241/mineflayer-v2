...
export const EARLY_GAME_BLUEPRINTS = Object.freeze([
  ...
  { templateId:'early-crop-farm-v1', category:'CROP_FARM', earlyGameValue:90, craftBurden:1, stage:'STONE', name:'MineHive Starter Crop Farm', width:7, depth:7, height:2, blocks:[...farmBorder(7,7,'cobblestone'),block(3,1,0,'oak_fence_gate',{facing:'south',open:false}),block(1,0,1,'composter'),block(5,0,5,'chest')] },
