...
export class Task {
  constructor({ id = randomUUID(), goalId, type, input = {}, requiredCapabilities = [], dependencies = [], priority = 50, retries = 2, timeout = 30_000, verify }) {
    ...
    this.assignedBot = null; this.retries = retries; this.attempts = 0; this.timeout = timeout; this.verify = verify;
