...
function normalizeResources(value) { const raw = value && typeof value === 'object' && !Array.isArray(value) ? value : {}; return { inputs: normalizeEntries(raw.inputs), outputs: normalizeEntries(raw.outputs) }; }
