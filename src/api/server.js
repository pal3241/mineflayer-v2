  ...
  async start() {
    ...
    this.server = createServer(async (req, res) => {
      ...
      try {
        ...
        if (req.method === 'POST' && url.pathname === '/api/v1/ml/local-dialogue/respond') { const input = await body(req); return send(200, { data:this.application.localBrain.respond(input.text, input.context) }); }
