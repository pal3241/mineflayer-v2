...
export class MemoryRepository {
  ...
  async update(id, patch) { const value = await this.find(id); const updated = { ...value, ...structuredClone(patch), id }; this.#items.set(id, updated); return structuredClone(updated); }
