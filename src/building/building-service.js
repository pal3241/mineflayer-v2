...
class BuildingService {
  ...
  protocol() { return { protocol: 'minehive.building', version: '1.1', apiVersion: 'v1', transports: ['http-poll'], synchronization: { snapshot: true, delta: true, revisionField: 'revision' }, commands: ['place', 'approve', 'build', 'pause', 'resume', 'cancel'], formats: [{ id: 'minehive-json', mode: 'native' }, { id: 'schem', mode: 'decoder-adapter' }, { id: 'litematic', mode: 'decoder-adapter' }], rendering: { inWorldGhost: 'planned', litematicaAdapter: 'optional-planned' } }; }
